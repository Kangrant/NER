...
def init_logger(log_file=None, log_file_level=logging.NOTSET):
    ...
    console_handler = logging.StreamHandler() # 创建一个handler，用于输出到控制台
    console_handler.setFormatter(log_format)  # 输出到console的log等级的开关
    logger.handlers = [console_handler]
    if log_file and log_file != '':
        file_handler = logging.FileHandler(log_file) # 日志文件
